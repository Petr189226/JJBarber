...
```
index.html
admin/           (admin/index.html – fallback pro /admin)
.htaccess
assets/          (JS, CSS)
hero-*.webp, hero.png
logo-*.webp, logo.png
...
**FileZilla:** Zapni zobrazení skrytých souborů (Server → Force showing hidden files), aby se nahrál `.htaccess`. Bez něj funguje SPA díky složce `admin/`.

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="w-9 h-9 border border-[#222222] hover:border-[#C9A84C]/40 rounded-sm flex items-center justify-center text-[#4A4A4A] hover:text-[#C9A84C] transition-all duration-300" aria-label="Instagram">
                <Instagram size={15} />
              </a>
              <a href={FACEBOOK_URL} target="_blank" rel="noopener noreferrer" className="w-9 h-9 border border-[#222222] hover:border-[#C9A84C]/40 rounded-sm flex items-center justify-center text-[#4A4A4A] hover:text-[#C9A84C] transition-all duration-300" aria-label="Facebook">
                <Facebook size={15} />
              </a>
            </div>
          </div>

...
export function TermsModal({ open, onClose }: Props) {
  ...
  const content = lang === "cs" ? (
    <>
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>1. Provozovatel</h3>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>2. Objednávka dárkových poukazů</h3>
      <p className="text-[#8A8580] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>3. Rezervace služeb</h3>
      <p className="text-[#8A8580] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>4. Reklamace</h3>
      <p className="text-[#8A8580] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>5. Závěrečná ustanovení</h3>
    ...
    <>
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>1. Operator</h3>
      <p className="text-[#8A8580] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>2. Gift Voucher Orders</h3>
      <p className="text-[#8A8580] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>3. Service Bookings</h3>
      <p className="text-[#8A8580] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>4. Complaints</h3>
      <p className="text-[#8A8580] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>5. Final Provisions</h3>
      <p className="text-[#8A8580]" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>

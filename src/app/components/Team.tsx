...
function TeamCard({ barber, index }: { barber: typeof barbers[0]; index: number }) {
  return (
    <motion.div
      ...
      className="group"
    >
      <div className="relative overflow-hidden rounded-sm border border-[#1F1F1F] group-hover:border-white/[0.08] group-hover:-translate-y-0.5 group-hover:shadow-[0_4px_20px_rgba(0,0,0,0.2)] transition-all duration-[180ms] ease-[cubic-bezier(0.22,1,0.36,1)]">
...
export function Team() {
  ...
  return (
    <section id="team" className="py-32 bg-[#0A0A0A] scroll-mt-24">

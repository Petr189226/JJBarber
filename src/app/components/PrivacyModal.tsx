...
export function PrivacyModal({ open, onClose }: Props) {
  ...
  const content = lang === "cs" ? (
    <>
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>1. Správce údajů</h3>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>2. Jaké údaje zpracováváme</h3>
      <p className="text-[#8A8580] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>3. Účel a právní základ</h3>
      <p className="text-[#8A8580] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>4. Doba uchování</h3>
      <p className="text-[#8A8580] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>5. Vaše práva</h3>
      <p className="text-[#8A8580] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>6. Cookies a třetí strany</h3>
      <p className="text-[#8A8580] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>7. Kontakt</h3>
    ...
    <>
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>1. Data Controller</h3>
      <p className="text-[#8A8580] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>2. Data We Process</h3>
      <p className="text-[#8A8580] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>3. Purpose and Legal Basis</h3>
      <p className="text-[#8A8580] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>4. Retention</h3>
      <p className="text-[#8A8580] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>5. Your Rights</h3>
      <p className="text-[#8A8580] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>6. Cookies and Third Parties</h3>
      <p className="text-[#8A8580] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>
      ...
      <h3 className="text-[#C4BEB4] font-semibold mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem" }}>7. Contact</h3>
      <p className="text-[#8A8580]" style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", lineHeight: 1.7 }}>
      ...
      <div className="relative w-full max-w-2xl max-h-[85vh] overflow-hidden bg-[#0D0D0D] border border-[#1F1F1F] rounded-xl shadow-2xl">
            <div className="sticky top-0 z-10 bg-[#0D0D0D] border-b border-[#1F1F1F] px-6 lg:px-8 py-5 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-[#C4BEB4]" style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 700, fontSize: "1.3rem" }}>
                  {t("footer.privacy")}
                </h2>
              </div>
              <button

...
export const translations: Record<string, Record<Lang, string>> = {
  ...
  "hero.headline1": { cs: "Nejlépe hodnocený barber", en: "Top-rated barber" },
  "hero.headline2": { cs: "na Praze 10", en: "in Prague 10" },
  "hero.sub": {
    cs: "4.9⭐ Google hodnocení | 4000+ spokojených zákazníků",
    en: "4.9⭐ Google rating | 4000+ happy customers",
  },
  "hero.cta": { cs: "Rezervovat termín ještě dnes", en: "Book your appointment today" },
  "hero.sub2": {
    cs: "Vršovice a Strašnice. Rezervuj si termín online — zabere to méně než minutu.",
    en: "Vršovice & Strašnice. Book online — takes less than a minute.",
  },
  "why.label": { cs: "Proč si vybrat nás", en: "Why choose us" },
  "why.heading": {
    cs: "Proč si zákazníci vybírají J&J",
    en: "Why customers choose J&J",
  },
  "why.rating": { cs: "Google hodnocení", en: "Google rating" },
  "why.barbers": { cs: "zkušených barberů", en: "experienced barbers" },
  "why.salon": { cs: "Moderní salon", en: "Modern salon" },
  "why.booking": { cs: "Rezervace online", en: "Online booking" },
  "why.parking": { cs: "Parkování v okolí", en: "Parking nearby" },
  ...
  "team.barber": { cs: "Barber", en: "Barber" },
  "team.years": { cs: "let praxe", en: "years exp." },
  "team.spec.fade": { cs: "Fade, vousy", en: "Fade, beard" },
  "team.spec.classic": { cs: "Klasické střihy", en: "Classic cuts" },
  "team.spec.beard": { cs: "Vousy, holení", en: "Beard, shave" },
  "team.spec.shave": { cs: "Holení břitvou", en: "Straight razor" },
  ...
  "rev.count": { cs: "400+ recenzí", en: "400+ reviews" },

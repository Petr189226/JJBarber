...
export const translations: Record<string, Record<Lang, string>> = {
  ...
  "hero.ann.label1": { cs: "Praha 10", en: "Prague 10" },
  "hero.ann.label2": { cs: "Od 2020", en: "Since 2020" },
  "hero.ann.label3": { cs: "Vršovice + Strašnice", en: "Vršovice & Strašnice" },
  "hero.big1": { cs: "TVŮJ", en: "YOUR" },
  "hero.big2": { cs: "BARBER", en: "BARBER" },
  "hero.big3": { cs: "SHOP.", en: "SHOP." },
  "hero.subline": { cs: "na Praze 10", en: "in Prague 10" },
  ...
  "rev.title1": { cs: "Co říkají", en: "What our" },
  "rev.title2": { cs: "zákazníci", en: "customers say" },
  "rev.descriptionLong": {
    cs: "Naši zákazníci mluví za nás. Každý střih, každá úprava vousů — vše děláme s péčí a precizností. Přečti si, co říkají ti, kteří se k nám pravidelně vracejí.",
    en: "Our customers speak for us. Every haircut and beard trim is done with care and precision. Read what people who keep coming back say about us.",
  },
  "rev.allOnGoogle": { cs: "Všechny recenze na Google", en: "All reviews on Google" },
  ...
  "book.bottomNote": {
    cs: "Online rezervace je zdarma a nezávazná",
    en: "Online booking is free and without obligation",
  },
  ...
  "voucher.tag": { cs: "Pro vaše blízké", en: "For your loved ones" },
  "voucher.feature1": { cs: "Platný ve všech pobočkách", en: "Valid at all locations" },
  "voucher.feature2": { cs: "Libovolná hodnota", en: "Any value" },
  "voucher.feature3": { cs: "Nelze refundovat", en: "Non‑refundable" },
